...
# basePath的路径要采用用绝对路径!!!!!!!!!!!!!!!!!!!!!!!!!!!
trainCleanSpeechRootDir = r'A:/BaiduNetdiskDownload/traindata/small_img'
if __name__ == '__main__':

        with open('./train.scp', 'w', encoding='utf-8') as fp:
                name = []
                target_csv_files = pd.read_csv(r"A:/BaiduNetdiskDownload/traindata/data2/target.csv", encoding='ANSI')
